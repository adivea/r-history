...
Go to the Github page for this curriculum and download the dataset called
"`kings.csv`". The direct download link is:
[https://raw.githubusercontent.com/adivea/r-history/main/episodes/data/kings.csv](https://raw.githubusercontent.com/adivea/r-history/main/episodes/data/kings.csv). Place this downloaded file in
the `data/` you just created. You can do this directly from R by copying and
pasting this in your terminal:

```{r download-data, eval=FALSE}
download.file("https://raw.githubusercontent.com/adivea/r-history/main/episodes/data/kings.csv",
              "data/kings.csv", mode = "wb")
```
