...
You can download it from [Github](https://github.com/adivea/r-history/blob/main/episodes/data/arabian.csv). Let's download the dataset and import it into R.
```{r load-arabian-nights-dataframe}
download.file("https://github.com/adivea/r-history/blob/main/episodes/data/arabian.rds", 
              "data/arabian.csv")

an_df1 <- read_csv("data/arabian.csv")
